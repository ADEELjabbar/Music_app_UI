...
import 'package:music_app/design_screens/trending_design.dart';
import 'package:music_app/providers/trendings_pro.dart';
import 'package:provider/provider.dart';

class Trending_Arch extends StatelessWidget {
  const Trending_Arch({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final obj=Provider.of<Trending_pro>(context).trendingGet;
    return Scaffold(
...
Expanded(
  child:   ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index)=>Trending_Design(songName: obj[index].SongName, songPic: obj[index].songPic, songAddress: obj[index].songAddress)),
)
